...
function createJobsRouter({ checkRateLimit, getSiteFromHeaders, createJob, getJobRecord }) {
  ...
  router.post('/', async (req, res) => {
    ...
    const siteData = await getSiteFromHeaders(undefined, req); // supabase used inside helper
